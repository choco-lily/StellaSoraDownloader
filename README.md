# StellaSora Downloader

A comprehensive GUI application for downloading StellaSora game files from multiple servers with advanced comparison and selection features.

## 🌍 Language / 언어 / 语言 / 言語

- 🇺🇸 [English](i18n/README_en.md) - Full documentation in English
- 🇰🇷 [한국어](i18n/README_ko.md) - 한국어로 된 전체 문서
- 🇨🇳 [中文](i18n/README_zh.md) - 中文完整文档
- 🇯🇵 [日本語](i18n/README_ja.md) - 日本語の完全なドキュメント
...
- Select from available StellaSora servers
...
- **KR Server**: Korean StellaSora server
- **EN Server**: English StellaSora server  
- **JP Server**: Japanese StellaSora server
- **CN Server**: Chinese StellaSora server
